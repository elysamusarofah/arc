...
import GMPCEffect from "@/components/GMPCEffect";
...
const HomePage = () => {
  ...
  const [showGMPCEffect, setShowGMPCEffect] = useState(false);
  ...
  const handleReset = () => {
    setFormData({ name: "", bio: "", role: "", score: "" });
    setPhotoFile(null);
    setPhotoPreview("");
    setProfile(null);
  };
  ...
  return (
    <div className="cyber-bg min-h-screen relative overflow-hidden">
      ...
      <header className="relative z-10 py-8 px-6 border-b border-purple-500/20">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Button
              data-testid="gamepc-btn"
              onClick={() => navigate("/gamepc")}
              className="bg-transparent border-2 border-purple-500 text-purple-400 hover:bg-purple-500/10"
            >
              🎮 GAMEPC
            </Button>
            <Button
              data-testid="gmpc-btn"
              onClick={() => setShowGMPCEffect(true)}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-6">
            ...
            <Card className="bg-gray-900/50 backdrop-blur-md border-2 border-purple-500/30 p-6 space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="score" className="text-purple-400">Score *</Label>
                <Input
                  id="score"
                  name="score"
                  type="number"
                    ...
                    <div className="relative z-10 space-y-6">
                      ...
                      <div className="text-center space-y-3">
                        <div>
                          ...
                          <p className="text-purple-400 font-bold" data-testid="profile-role">
                            {profile.role}
                          </p>
                        </div>
                        ...
                        <div className="py-3 px-4 bg-black/40 rounded-lg border border-purple-500/30">
                          <p className="text-xs text-gray-400 mb-1 font-bold">ENCRYPTED SCORE</p>
                          <p className="text-lg font-bold text-white" data-testid="profile-score">
                            #{profile.score}
                          </p>
                        </div>
                        ...
                        {profile.bio && (
                          <div className="text-left py-3 px-4 bg-black/20 rounded-lg border border-purple-500/10">
                            <p className="text-xs text-gray-400 mb-2 font-bold">BIO</p>
                            <p className="text-sm text-gray-300 leading-relaxed font-bold" data-testid="profile-bio">
                              {profile.bio}
                            </p>
                          </div>
                        )}
                ...
                <div className="profile-card opacity-50">
                  <div className="relative z-10 space-y-6">
                    ...
                    <div className="text-center space-y-3">
                      ...
                      <div className="py-3 px-4 bg-black/40 rounded-lg border border-purple-500/30">
                        <p className="text-xs text-gray-600 mb-1 font-bold">ENCRYPTED SCORE</p>
                        <p className="text-gray-700 text-lg font-mono font-bold">#XXXXXXXXXXXX</p>
                      </div>
      ...
      {/* gMPC Effect */}
      {showGMPCEffect && (
        <GMPCEffect onClose={() => setShowGMPCEffect(false)} />
      )}
    </div>
  );
};
